...
ggsave('scatterpvals_stat.png',path='./results/', dpi=300)
...
ggplot(anova_df, aes(cell_line, pathway), size=pval) +
  ...
  theme(axis.text.x = element_text(angle = 45,hjust=1,vjust=1)) +
  facet_grid(~ eval)
ggsave('scatterpvalspathway_stat.png',path='./results/', dpi=300)
...
ggsave('metanalysisacross_stat.png',path='./results/', dpi=300)
