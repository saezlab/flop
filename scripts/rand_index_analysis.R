...
print(datafile)
#datafile <- "./results/GSE186341/filtered/GSE186341__result.tsv"
...
save_plot(filename = 'rand_index_plots.png', plot = final, device='png', dpi=300, base_height=7.5, base_width =10)
